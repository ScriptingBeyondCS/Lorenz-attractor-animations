...
x_t = np.asarray([integrate.odeint(lorentz_deriv, (1,1,1), t, args=(sigma[k][0], 8./3, 28.0))
...
anim = animation.FuncAnimation(fig, animate, init_func=init,
                               frames=3000, interval=30, blit=True)


mywriter = animation.FFMpegWriter()
anim.save('chaotic_sigma.mp4', writer='ffmpeg', fps=60, extra_args=['-vcodec', 'libx264'], bitrate=4000)
