...
x_t = np.asarray([integrate.odeint(lorentz_deriv, (1,1,1), t, args=(sigma[k][0],beta[k][0], rho[k][0]))
...
anim.save('chaotic_all_parameters.mp4', writer='ffmpeg', fps=60, extra_args=['-vcodec', 'libx264'], bitrate=8000)
